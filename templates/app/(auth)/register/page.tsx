      ...
      >
        {showVerificationMessage ? (
          ...
          <AuthForm onSubmit={handleSubmit} loading={loading} error={error && !fieldErrors.email ? genericError : undefined}>
            <OAuthButtons providers={oauthProviders} loadingProvider={loadingProvider} onSignIn={signIn} />
            ...
            <FormField label="Confirm password" htmlFor="register-confirm" error={fieldErrors.confirm} required>
              <PasswordInput
                id="register-confirm"
                placeholder="••••••••"
