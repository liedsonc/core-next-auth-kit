...
const providerLogos: Record<OAuthProvider, React.ComponentType<{ className?: string }>> = {
  google: GoogleLogo,
  apple: AppleLogo,
};
...
export function OAuthButtons({
  ...
  return (
    <div className={cn("auth-ui-oauth-grid", enabled.length === 1 && "auth-ui-oauth-grid-single", className)}>
        ...
        return (
          ...
          >
            {isLoading ? (
              ...
              <>
                <Logo className="auth-ui-oauth-logo" />
